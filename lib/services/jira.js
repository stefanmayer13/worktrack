...
exports.getTasks = function (user, dateFrom, dateTo, callback) {
  ...
  var fields = '&addIssueSummary=true',
    options = {
      ...
      path: '/plugins/servlet/tempo-getWorklog/?format=xml&diffOnly=false&tempoApiToken=' + token + '&' +
        'dateFrom=' + from + '&dateTo=' + to + '&userName=' + user.username + fields,
      method: 'GET'
    };
...
exports.getTasksForDay = function (user, date, callback) {
  var day = new Date(date);
  exports.getTasks(user, day, day, callback);
};
